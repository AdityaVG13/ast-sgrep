...
const validateFiles = (state, artifact) => {
  ...
  const required = artifact.layer === 'native'
    ...
    : artifact.layer === 'launcher'
      ...
      : ['LICENSE', 'README.md', 'assets/preview.png', 'dist/codemode/index.d.ts', 'dist/codemode/index.js', 'dist/codemode/native.d.ts', 'dist/codemode/native.js', 'dist/codemode/guest-worker.mjs', 'dist/index.d.ts', 'dist/index.js', 'dist/present.d.ts', 'dist/present.js', 'dist/runtime.d.ts', 'dist/runtime.js', 'dist/types.d.ts', 'dist/types.js', 'dist/config.d.ts', 'dist/config.js', 'dist/freshness.d.ts', 'dist/freshness.js', 'dist/index-health.d.ts', 'dist/index-health.js', 'dist/envelope.d.ts', 'dist/envelope.js', 'dist/tools.d.ts', 'dist/tools.js', 'dist/commands.d.ts', 'dist/commands.js', 'native/README.md', 'package.json'];
