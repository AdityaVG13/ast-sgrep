...
use crate::types::{Position, Range, SYMBOL_KIND_FUNCTION, SYMBOL_KIND_METHOD, SYMBOL_KIND_STRING};
...
pub fn line_range_ext(line_start: u32, line_end: u32, end_line_text: Option<&str>) -> Range {
    Range {
        ...
        end: Position { line: line_end.saturating_sub(1), character: end_line_text.map(line_utf16_len).unwrap_or(0) },
    }
}
