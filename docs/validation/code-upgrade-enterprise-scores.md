...
| C-IGNORE-DRIFT | 3 `#[ignore]` vs inherited baseline 4; suite not re-run on PIN | verification | 6 | 7 | 2 | **21.0** | `rch exec -- cargo test --workspace --no-fail-fast` + reconcile count |
